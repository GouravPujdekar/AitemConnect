...
<head>  
 ...
 <body>
    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo" ng-app="myApp" ng-controller="loginCtrl" ng-init="init()" style="background-image:url('<?php echo base_url('images/way11.jpg');?>');background-size:1000px;">
